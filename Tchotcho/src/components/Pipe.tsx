...
function PipeComponent({ x, topHeight, gapEnd, screenHeight }: PipeProps) {
  const bottomHeight = screenHeight - gapEnd;
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0" style={{ left: 0, height: topHeight, overflow: 'hidden' }}>
      ...
      {/* الأنبوب السفلي */}
      <div className="absolute" style={{ left: 0, top: gapEnd, height: bottomHeight }}>
